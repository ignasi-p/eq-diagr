...
Name "Database Launcher"
Caption "Database Java Launcher"
Icon "images/Database.ico"
...
!define /date DATE "%Y.%m.%d.01"
  ...
  VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductName" "Database Java Launcher"
  VIAddVersionKey /LANG=${LANG_ENGLISH} "Comments" "launches Database.jar"
  VIAddVersionKey /LANG=${LANG_ENGLISH} "LegalCopyright" "I.Puigdomenech"
  VIAddVersionKey /LANG=${LANG_ENGLISH} "FileDescription" "Hydrochemical logK Database"
...
!define CLASSPATH "DataBase.jar"
!define JAR "DataBase.jar"
!define PRODUCT_NAME "DataBase"
