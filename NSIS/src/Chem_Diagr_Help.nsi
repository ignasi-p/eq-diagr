...
Name "Java Launcher for Chemical Equilibrium Diagrams Help"
Caption "Chem.Equil.Help Java Launcher"
Icon "images/Help.ico"
OutFile "Chem_Diagr_Help.exe"
;--------------------------------
;Include Version Information
LoadLanguageFile "${NSISDIR}\Contrib\Language files\English.nlf"
!define /date DATE "%Y.%m.%d.01"
  VIProductVersion "${DATE}"
  VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductName" "Java Launcher for Chemical Equilibrium Diagrams Help"
  VIAddVersionKey /LANG=${LANG_ENGLISH} "Comments" "Launches Chem_Diagr_Help.jar"
...
!define CLASSPATH "Chem_Diagr_Help.jar"
!define JAR "Chem_Diagr_Help.jar"
!define PRODUCT_NAME "Chem_Diagr_Help"
