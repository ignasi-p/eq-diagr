...
Name "Spana Launcher"
Caption "Spana Launcher"
Icon "images/Spana_diagram.ico"
OutFile "Spana.exe"
;--------------------------------
...
!define /date DATE "%Y.%m.%d.01"
  ...
  VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductName" "Spana Java Launcher"
  VIAddVersionKey /LANG=${LANG_ENGLISH} "Comments" "launches Spana.jar"
  VIAddVersionKey /LANG=${LANG_ENGLISH} "LegalCopyright" "I.Puigdomenech"
  VIAddVersionKey /LANG=${LANG_ENGLISH} "FileDescription" "Spana (Chemical Equilibrium Diagrams)"
...
!define CLASSPATH "Spana.jar"
!define JAR "Spana.jar"
!define PRODUCT_NAME "Spana"
...
Section ""
  ...
  ;Note: for the PortableApps launcher, it is necessary to wait for
  ;  this launcher (Spana.exe) to finish before restoring the Windows registry
  ExecWait "$2" $3
        IfErrors +1 +2
