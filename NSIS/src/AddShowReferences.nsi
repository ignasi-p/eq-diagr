;-----------------------------------------------
;  AddShowReferences.nsi
;-----------------------------------------------
; Java Launcher
;-----------------------------------------------

Name "AddShowReferences Launcher"
Caption "AddShowReferences Launcher"
Icon "images/Refs.ico"
OutFile "AddShowReferences.exe"
;--------------------------------
;Include Version Information
LoadLanguageFile "${NSISDIR}\Contrib\Language files\English.nlf"
!define /date DATE "%Y.%m.%d.01"
  VIProductVersion "${DATE}"
  VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductName" "AddShowReferences Launcher"
  VIAddVersionKey /LANG=${LANG_ENGLISH} "Comments" "launches AddShowReferences.jar"
  VIAddVersionKey /LANG=${LANG_ENGLISH} "LegalCopyright" "I.Puigdomenech"
  VIAddVersionKey /LANG=${LANG_ENGLISH} "FileDescription" "Edits file 'References.txt'"
...
!define CLASSPATH "AddShowReferences.jar"
!define JAR "AddShowReferences.jar"
!define PRODUCT_NAME "AddShowReferences"
