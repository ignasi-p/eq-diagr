...
Name "SED Java Launcher"
Caption "SED Java Launcher"
Icon "images/SED.ico"
OutFile "SED.exe"
;--------------------------------
...
!define /date DATE "%Y.%m.%d.01"
  ...
  VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductName" "SED Java Launcher"
  VIAddVersionKey /LANG=${LANG_ENGLISH} "Comments" "launches SED.jar"
...
!define CLASSPATH "SED.jar"
!define JAR "SED.jar"
!define PRODUCT_NAME "SED"
