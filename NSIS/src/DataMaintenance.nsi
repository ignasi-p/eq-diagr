...
!define /date DATE "%Y.%m.%d.01"
  ...
  VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductName" "DataMaintenance Launcher"
  VIAddVersionKey /LANG=${LANG_ENGLISH} "Comments" "launches DataMaintenance.jar"
  VIAddVersionKey /LANG=${LANG_ENGLISH} "LegalCopyright" "I.Puigdomenech"
  VIAddVersionKey /LANG=${LANG_ENGLISH} "FileDescription" "DataMaintenance for Hydrochemical logK database"
...
!define CLASSPATH "DataMaintenance.jar"
!define JAR "DataMaintenance.jar"
!define PRODUCT_NAME "DataMaintenance"
